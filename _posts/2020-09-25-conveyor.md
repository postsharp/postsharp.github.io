...
published: false
---
If you're developing a web application, you want to test and debug it from devices other than your development machine. In this article, we'll show how you can do that - even if the website is not yet deployed - and also how you can find errors in your code in such a situation with detailed automatic logging. We will be using Conveyor and PostSharp Logging.
