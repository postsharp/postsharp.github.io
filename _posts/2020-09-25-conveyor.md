...
layout: post
comments: true
title: "Improved debugging with Conveyor and PostSharp Logging"
permalink: /post/improved-debugging-with-conveyor-and-postsharp-logging.html
author: "Petr H. and Jim Wright"
published: false
---
In this article, we'll show how you can debug an ASP.NET application on your developer machine from other devices on your network or from the internet. We will also show how you can find errors in your code with detailed automatic logging. We will be using Conveyor and PostSharp Logging. Together, these tools can improve your debugging experience.
...
<img src="/assets/images/blog/2020-09-25-conveyor/ClockInScreenshot.PNG" width="100%" />
